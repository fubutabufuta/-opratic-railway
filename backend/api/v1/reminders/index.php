...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        ...
        // User ID al - Test için sabit 1 kullan, production'da token'dan al
        $user_id = 1; // Test için sabit kullanıcı ID
        ...
        // Debug için user_id'yi logla
        error_log("Reminders API - User ID: $user_id");
